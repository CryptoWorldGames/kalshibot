...
# Vehicle performance profiles. range_km / pax are used for real trip planning
# (battery-range checks and capacity), not just visualisation.
VEHICLES = {
    "drone": {"label": "Delivery drone", "cruise_mps": 18.0, "climb_mps": 4.0,
              "color": "#36d399", "size": 1.0, "alt_offset_m": 0,
              "range_km": 24.0, "pax": 0, "payload_kg": 2.3},
    "evtol": {"label": "eVTOL air taxi", "cruise_mps": 55.0, "climb_mps": 6.0,
              "color": "#38bdf8", "size": 1.8, "alt_offset_m": 15,
              "range_km": 160.0, "pax": 4, "payload_kg": 0},
}
